...
SRC = taxi_assignment_instance.cpp taxi_assignment_solution.cpp checker.cpp greedy_solver.cpp taxi_assignment_batching_solver.cpp taxi_batching_modificado.cpp main.cpp
OBJ = $(SRC:.cpp=.o)
EXEC = taxi_batching
all: $(EXEC)
